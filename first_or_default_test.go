...
func Test_enumerable_FirstOrDefaultSafeBy_FirstOrDefaultBy(t *testing.T) {
	tests := []struct {
		name         string
		src          IEnumerable[int]
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			gotResult, err := tt.src.FirstOrDefaultSafeBy(tt.predicate, tt.defaultValue)
			...
			if tt.wantErr {
				...
				_ = tt.src.FirstOrDefaultBy(tt.predicate, tt.defaultValue)
			} else if err == nil {
